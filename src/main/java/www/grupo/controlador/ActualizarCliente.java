...
import www.group.dao.ClienteDAO;
...
public class ActualizarCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            dto.getEntidad().setIdCliente(Integer.parseInt(request.getParameter("id")));
            try {
                dto = dao.read(dto);
                ...
                out.println("<input type='text' class='form-control' id='id' name='id' value='" + dto.getEntidad().getIdCliente()+ "' readonly/>");
                
                out.println("<label for='txtPaterno' class='form-label'> Clvae Provedor</label>");
                out.println("<input type='text' class='form-control' id='txtPaterno' name='txtPaterno' value='" + dto.getEntidad().getApellidoPaterno()+ "' readonly/>");
                
                out.println("<label for='txtMaterno' class='form-label'> Clvae Provedor</label>");
                out.println("<input type='text' class='form-control' id='txtMaterno' name='txtMaterno' value='" + dto.getEntidad().getApellidoMaterno()+ "' readonly/>");
                
                out.println("<label for='txtNombre' class='form-label'> Nombre </label>");
                out.println("<input type='text' class='form-control' id='txtNombre' name='txtNombre' value='" + dto.getEntidad().getNombreCliente()+ "' />");
